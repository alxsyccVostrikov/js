...
*/
 	document.write("<style>"
		...
		"nav.sidebar .navbar-collapse, nav.sidebar .container-fluid{padding: 0 0px 0 0px;}</style>"+
		"nav.sidebar{width: 150px;height: 100%;margin-left: -160px;float: left;z-index: 8000;margin-bottom: 0px;}"+
		"nav.sidebar li {width: 100%;}}"+
		"@media (min-width: 1330px) {"+
		".main{width: calc(100% - 200px);margin-left: 200px;}"+
